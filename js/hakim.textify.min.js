...
var Textify = (function() {
    ...
    var I = {
        Prof: {
            ...
            filter: "None",
            useCanvas: true,
            characterSet: "Ḻ̛͈͙̻͓̈̿̓ͧ̐ͥͯ̓ͮ͋͆̀͑ͮͪͪ͝͝S̶̓̍͌ͯ͛̐̀̄̈́҉̡͏̩̬̹̤̖̯̦̯̜̖̖͡C̸̴̪̭̬̥͕̼̮͈̟͉͇͎͖̹ͪ̈ͣ̓͐͒͊͌ͨ̔͊͗̿̓ͮ̑̏͟͡͠Ḧ́̏̾̽͂͌ͬ̃ͦ̅́̌̌́ͣͮ̚҉͈̫̝͉̩̖̀S̡͉̟͖̮͕͇̲̠̣̻̍ͭ̂͐ͩͭͨͨͧͥ̔̈́̌̄͌ͧ̇̚͟͡",
            characterLimit: 100000000000000,
            characterScale: 1,
    ...
    function ai() {
        ...
        x = Y.add(ad, "preset").name("Preset").options("Prof").onChange(function(aj) {
            x.removeOption(w);
            t(I[aj]);
        });
        ...
        U = Y.add(ad, "characterLimit").name("Character Count").min(1000).step(500).listen().onChange(D);
